...
| openclaw | AI assistant gateway (LXC on nuc13, VMID 202) — removed 2026-09-11 |
...
- **OpenClaw** _(removed 2026-09-11 — LXC destroyed, PBS backups retained, config kept for possible revival)_ — formerly an LXC container on nuc13 (VMID 202, 2 cores / 4 GB RAM). AI assistant gateway with Telegram bot integration. Primary model: OpenAI Codex (gpt-5.3-codex). Included Whisper-based audio transcription (faster-whisper, CPU) and Edge TTS for voice responses.
